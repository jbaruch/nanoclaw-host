...
describe('sanitizeToolResponse', () => {
  ...
  // Bare-array shape: some MCP clients return tool_result content as a
  // bare array, no { content: ... } envelope. Without these tests, the
  // walker can silently regress to a no-op for that shape (issue #11).
